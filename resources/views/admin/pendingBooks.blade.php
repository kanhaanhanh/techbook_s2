                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="button-container" style="display: flex; gap: 10px; align-items: center;">
                                                    <button onclick="showDetails('{{ $book->ISBN }}', '{{ $book->title }}', '{{ $book->category->name }}', '{{ $book->author_name }}', '{{ $book->published_date }}', '{{ $book->price }}', '{{ $book->cover_url }}', '{{ $book->status }}', '{{ $book->type }}', '{{ $book->book_url }}','{{ $book->updated_at }}')" class="btn btn-primary">
